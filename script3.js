...
let Colors = {
  ...
  ambientLight = new THREE.AmbientLight(0xFF8844,.3);
  directionLight = new THREE.DirectionalLight(0xffffff ,.3);
  directionLight.position.set(40,10,0);
  directionLight.target.position.set(-10, 0, 0);
  ...
  var bodyGeom = new THREE.BoxGeometry (15,10,15);
  ...
  var hairGeom = new THREE.BoxGeometry (4,3,1);
  ...
  for (var i=0; i<12; i++){
    ...
    var startPozZ = -2;
    var startPozX = -2;
    h.position.set(startPozX+row*4, -1, startPozZ+col*4);
    this.hairsTop.add(h);
  }
  hairs.add(this.hairsTop);

  var hairSideGeom = new THREE.BoxGeometry (8,3,2);
  hairSideGeom.applyMatrix(new THREE.Matrix4().makeTranslation(2,8,10));
  var hairSideR = new THREE.Mesh(hairSideGeom, hairMat);
  var hairSideL = hairSideR.clone();
  hairSideR.position.set(2,-10,-5);
  hairSideL.position.set(2,-10,-15);
  hairs.add(hairSideL);
  hairs.add(hairSideR);

  var hairBackGeom = new THREE.BoxGeometry(2,8,7);
  var hairBack = new THREE.Mesh(hairBackGeom, hairMat);
  hairBack.position.set(-1,-3,0);
  hairs.add(hairBack);

  hairs.position.set(-5,7,0);
  this.mesh.add(hairs);

  var glassGeom =new THREE.BoxGeometry (4, 4, 4);
  var glassMat = new THREE.MeshLambertMaterial({color: Colors.blue});
  var glassR = new THREE.Mesh(glassGeom, glassMat);
  glassR.position.set(6,3,3);
  var glassL = glassR.clone();
  glassL.position.z = -glassR.position.z;

  var glassAGeom = new THREE.BoxGeometry (11,1,11);
  var glassA = new THREE.Mesh (glassAGeom, glassMat);
  glassA.position.set(0,3,3);

  var earGeom = new THREE.BoxGeometry (3,5,2);
  var earMat = new THREE.MeshLambertMaterial({color: Colors.skin});
  var earL = new THREE.Mesh (earGeom, earMat);
  earL.position.set(0,2,-7);
  var earR = earL.clone();
  earR.position.set(0,2,7);
  ...
  tailPlane.rotation.z=0.05*Math.PI 
...
this.mesh.receiveShadow = true;
  ...
  function getSmoke () {
    ...
    mesh.name = "smoke";
    mesh.position.x = airplane.mesh.position.x - (Math.random()*10 - 7);
  ...
  var targetY = normalize(mousePos.y,-.75,.75,25, 190);
  ...
  airplane.mesh.rotation.x = (airplane.mesh.position.y - targetY)*0.044;
  ...
  setInterval (()=>{
    ...
    smokeMoveInterval = setInterval (()=>{
      ...
      setTimeout (() => clearInterval(smokeMoveInterval),10)
